import { SettingOption } from "../../features/settings/settingsSlice"

export const settingDefinitions: SettingOption[] = [
	{
		settingName: "timestampButtonsEnabled",
	...
	{
		settingName: "saveVideoTimestampButtonEnabled",
	...
	{
		settingName: "pinCurrentTimestampShortcut",
	...
	{
		settingName: "useAutoSaveLatestTimestamp",
	...
	{
		settingName: "onlyBringAutoSavedTimestampForward",
	...
	{
		settingName: "autoSaveLatestTimestampMessage",
